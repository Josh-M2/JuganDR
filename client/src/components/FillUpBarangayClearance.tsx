...
const FillUpIndigency: React.FC = () => {
  ...
  const [form, setForm] = useState<IndigencyForm>(() => {
    const savedForm = localStorage.getItem("nbiClearanceForm");
    return savedForm
      ? JSON.parse(savedForm)
      : {
          form: "barangay_clearance",
          first_name: "",
          middle_name: "",
          last_name: "",
          ext_name: "",
  ...
  useEffect(() => {
    localStorage.setItem("nbiClearanceForm", JSON.stringify(form));
  }, [form]);
  ...
  const clearFormData = () => {
    localStorage.removeItem("nbiClearanceForm");
    setForm({
      form: "barangay_clearance",
      first_name: "",
      middle_name: "",
